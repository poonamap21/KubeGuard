...
class GitHubClient:
    def __init__(self, git_token: str):
        """
        Initializes the client with the authentication token so 
        you don't have to keep passing it around.
        """
    ...
    def get_modified_yaml_files(self, repo_name: str, pr_number: int) -> List[Dict[str, Any]]:
    ...
    def download_raw_content(self, raw_url: str) -> str:
        headers = {"Authorization": f"token {self.git_token}"}
